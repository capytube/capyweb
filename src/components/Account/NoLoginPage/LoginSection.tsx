  ...
  return (
    <div className="bg-grassGreen md:pt-10 md:pb-20 py-8 md:px-0 px-4">
      <div className="max-w-[1328px] flex flex-col justify-center items-center md:gap-y-14 gap-y-4 mx-auto">
        <h1 className="font-hanaleiFill md:text-titleSize text-titleSizeSM text-darkGreen">Join us for free</h1>
        <div className="md:max-w-max max-w-[305px]">
          <img src={PlayCapy} alt="play" className="md:max-h-max max-h-[150px]" />
        </div>
        <div className="flex flex-col gap-y-6">
          ...
          <p className="text-center font-commissioner text-chocoBrown md:text-titleSizeSM text-sm">
            Sign up for a free Capytube membership and get instant access to our live public streams, featuring the
            cutest capybaras in their daily antics!
          </p>
        </div>
        <div className="flex md:flex-row flex-col md:gap-x-14">
          <div className="px-4 max-w-md">
            <img src={WindowCapy} alt="winodw" className="md:max-h-max max-h-[150px] mx-auto" />
            ...
            <p className="font-commissioner md:text-titleSizeSM text-sm text-center text-chocoBrown">
              Watch our capybara gang as they play, munch, and relax—all for free! Your free membership gets you access
              to our rotating camera feed, so you never miss a moment.
            </p>
          </div>
          {/*<div className="px-4 max-w-md">*/}
          {/*  <img*/}
        ...
        >
          <div className="absolute top-2 opacity-0 w-full widget">
            <DynamicWidget
              ...
              innerButtonComponent={<p style={{ width: '324px', height: '28px' }}>Login or create Account</p>}
            />
          </div>
